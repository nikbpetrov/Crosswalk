...
setup(
  ...
  version = '0.0.0-b',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/nikbpetrov/crosswalk/archive/refs/tags/0.0.0-b.tar.gz',    # I explain this later on
