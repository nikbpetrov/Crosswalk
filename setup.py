...
setup(
  ...
  version = 'b0.0.0',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/nikbpetrov/crosswalk/archive/refs/tags/b0.0.0.tar.gz',    # I explain this later on
